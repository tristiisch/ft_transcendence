...
<template>
	...
	<div v-if="authStore.isLoading" class="flex items-center justify-center h-full font-Arlon text-white text-6xl">Loading</div>
	<div class="flex flex-col items-center justify-center h-full pb-32">
		...
		<button-gradient1 v-if="!authStore.isAuthenticated" @click="redirectTo42LoginPage()"><span>Login with 42</span></button-gradient1>
		<BaseCard v-else>
			<div class="flex gap-4 ">
				<div class="flex flex-col gap-4 ">
					...
					<input
						...
						type="text"
						name="username"
						v-model.trim="authStore.user.username"
