...
<template>
	...
	<div v-else>
		<div  @click="changeAvatar" class="flex items-center justify-center w-12 h-12 sm:w-20 sm:h-20 bg-neutral-100 text-blue-600 rounded-lg shadow-lg border border-blue-600 cursor-pointer hover:bg-blue-600 hover:text-neutral-100">
