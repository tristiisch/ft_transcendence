	...
	<div v-else class="flex flex-col justify-center items-center h-full w-full gap-4 sm:gap-8 sm:mt-3">
		...
		<form v-if="qrCode" class="flex flex-col w-full text-center text-xs sm:text-sm gap-4" @submit.prevent>
			...
			<div class="flex justify-center w-full gap-4">
				<input type="text" name="twoFaCode" v-model="twoFaCode" placeholder="2FA code" class="text-center text-xs text-blue-600 placeholder:text-slate-300 bg-neutral-100 border border-blue-600 rounded-lg placeholder:text-center" />
