...
<template>
    <div class="flex flex-col items-center w-full h-full">
		...
		<div v-if="mode === 'invite' || invitation === true" class="h-full flex flex-col justify-center items-center w-full pt-2 gap-4">
			<div class="flex justify-center items-center bg-neutral-100 border border-blue-600 text-blue-600 rounded-full min-w-[120px] min-h-[120px] sm:min-w-[150px] sm:min-h-[150px] w-[calc(0.18_*_100vh)] h-[calc(0.18_*_100vh)] w-[calc(0.2_*_100vh)] h-[calc(0.2_*_100vh)]">
				<img v-if="invitedUser" class="flex border border-blue-600 justify-center items-center min-w-[120px] min-h-[120px] sm:min-w-[150px] sm:min-h-[150px] w-[calc(0.165_*_100vh)] h-[calc(0.165_*_100vh)] w-[calc(0.185_*_100vh)] h-[calc(0.185_*_100vh)] rounded-full object-cover" :src=invitedUser.avatar>
			...
			<div v-if="invitedUser" class="flex justify-center items-center w-full text-red-100 text-xs sm:text-sm">
