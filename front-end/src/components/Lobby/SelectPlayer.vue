...
<template>
    <div class="flex flex-col items-center w-full h-full">
		...
		<div v-if="mode === 'invite' || invitation === true" class="flex flex-col h-[60%] justify-center items-center py-2 sm:py-4 w-3/4 bg-neutral-100 border border-blue-600 rounded-lg mt-2 3xl:mt-6">
