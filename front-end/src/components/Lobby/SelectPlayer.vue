...
<template>
    <div class="flex flex-col items-center w-full h-full">
        ...
        <div class="inline-flex justify-center w-full pt-4 sm:pt-6">
            <button @click="mode = 'random'" class="btn-base rounded-l-md border" :class="mode === 'random' ? 'bg-blue-600 text-white' : 'bg-neutral-100 text-blue-600'">Random</button>
            <button @click="mode = 'invite'" class="btn-base rounded-r-md border-t border-b" :class="mode === 'invite' ? 'bg-blue-600 text-white' : 'bg-neutral-100 text-blue-600'">Invite</button>
        </div>
    ...
    <div class="flex flex-col items-center w-full">
        ...
        <div class="flex w-3/4 justify-center items-center">
            <button class="bg-neutral-100 py-1 sm:py-2 w-full text-blue-600 rounded-md">LAUNCH</button>
        </div>
    </div>
</template>
...
<style scoped>
.btn-base {
	@apply w-[38%] py-1.5 sm:py-2.5 px-4 text-xs sm:text-sm border-blue-600 hover:bg-blue-600 hover:text-neutral-100 focus:bg-blue-600 focus:text-neutral-100;
}
</style>