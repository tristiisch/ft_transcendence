...
<template>
	<div v-if="!selectPlayer" class="flex flex-col justify-center items-center gap-6 h-full w-full">
		...
		<div class="inline-flex shadow-sm w-full sm:w-3/4">
		...
		<div v-if="protectedChannel" class="w-full sm:w-3/4">
		...
		<div>
			<button-gradient1 @click="selectPlayer = !selectPlayer">Confirm</button-gradient1>
		</div>
	</div>
