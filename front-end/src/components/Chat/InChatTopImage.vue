...
<template>
	<base-button v-if="inChatWith" link :to="{ name: 'Profile', params: { username: inChatWith.username }}" class="flex justify-center items-center gap-4 -mt-5 pb-2 sm:pb-5 w-full border-b-[1px] border-red-400">
	...
	<div v-else-if="inChannel" class="flex justify-between items-center gap-4 -mt-5 pb-2 sm:pb-5 w-full border-b-[1px] border-red-400">
