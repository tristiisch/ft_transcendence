...
<template>
     <button class="flex justify-between items-center w-full h-[60px] border-b-[1px] border-slate-600 pr-2">
        <div class="shrink-0 flex items-center h-full">
            <img class="w-8 h-8 sm:h-12 sm:w-12 rounded object-cover border-[1px] border-zinc-300" :src="channel.avatar" alt="Rounded avatar">
        </div>
        <p class="px-2 break-words truncate">{{ channel.name }}</p>
