		...
		<div class="flex flex-col gap-1 min-w-0">
			...
			<div v-else class="flex items-center gap-2 bg-neutral-100 border-[1px] border-blue-600 w-full h-[42px] sm:h-[52px] rounded-lg pl-1">
				...
				<div class="flex flex-col justify-center items-center gap-1" >
					...
					<svg v-if="message.idSender === userStore.userData.id && message.canUseButton" class="w-6 h-6 text-neutral-300 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
