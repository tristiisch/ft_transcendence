...
<template>
	...
	<div v-else>
		<input
			class="block w-full text-xs cursor-pointer rounded-md focus:outline-none text-red-200 file:py-1.5 file:text-xs file:bg-red-700 file:border-0 file:text-red-200"
